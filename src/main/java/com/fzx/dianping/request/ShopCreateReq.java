 ...
 * @Author: fanZhengxu
 * @Description:
 * @Date: Create in 19:35 2020/2/15
 */
public class ShopCreateReq {
    ...
    public ShopCreateReq(String name, Integer pricePerMan, BigDecimal latitude, BigDecimal longitude, Integer categoryId, String tags, String startTime, String endTime, String address, Integer sellerId, String iconUrl) {
        this.name = name;
        this.pricePerMan = pricePerMan;
        this.latitude = latitude;
        this.longitude = longitude;
